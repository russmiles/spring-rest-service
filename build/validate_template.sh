...
validation_response=$(curl -s -H "Content-Type: application/json" -X POST https://atomist.atomist.services/project-operation/validate-template -d '{ "owner": "atomist-project-templates", "repo": "spring-rest-service" }')
